...
| **Message**  | The request requires higher privleges than provided by the access token.                                                                                                                                                                                                                                                             |                                                                                                                                                                                                                                                 |
| **Solution   | This error is typically produced when scopes that are needed for the API operation are not enabled. Check your configured application sfcopes and reauthorize your application, if applicable.                                                                                                                                       |
|              |                                                                                                                                                                                                                                                                                                                                      |
