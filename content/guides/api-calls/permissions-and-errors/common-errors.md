...
|              |                                                                                                                                                                                                                                                                                                                                                                 |
| **Error**    | `dataset_too_large_for_offset_based_paging`                                                                                                                                                                                                                                                                                                                     |
| **Message**  | Exceeded quota supported by offset-based pagination for this endpoint, please use marker-based pagination                                                                                                                                                                                                                                                       |
| **Solution** | The user's trash has more than 100,000 items in it and can no longer be accessed using offset-based pagination. Use [marker-based pagination](g://api-calls/pagination/marker-based) instead                                                                                                                                                                    |
