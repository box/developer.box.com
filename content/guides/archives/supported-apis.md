...
| [`POST securityClassification`][Create classification label on file]         | Create a classification label attached to a file within an archive.                                                                                                                                                                                                        |
| [`GET securityClassification`][View classification label on file]            | View a classification label attached to a file within an archive.                                                                                                                                                                                                          |
| [`PUT securityClassification`][Update classification label on file]          | Update a classification label attached to a file within an archive.                                                                                                                                                                                                        |
| [`DELETE securityClassification`][Delete classification label on file]       | Delete a classification label attached to a file within an archive.                                                                                                                                                                                                        |
