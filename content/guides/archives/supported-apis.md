...
| [`PUT /folders/:id`][Update folder]                                          | Add a folder to an archive, restore a folder from an archive, move folder within/between archives, or rename and change description of a folder in an archive. Other updates to the folder are not allowed. Requires contacting customer support to enable. |
