...
|API model name|`aws__titan_text_lite`| The name of the model that is used in the [Box AI API for model overrides][override]. The user must provide this exact name for the API to work. |
