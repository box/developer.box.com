...
| `ITEM_EMAIL_SEND` | An email message is sent to a collaborator on an item |
...
| `SHARED_LINK_SEND` | An email with a shared link to an item and an optional message is sent |
