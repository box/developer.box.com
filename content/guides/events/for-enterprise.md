...
| `COLLECTION_UPDATE`                            | A collection was updated (e.g. was renamed)                                                     |
| `COLLECTION_ITEM_CREATE`                       | An item was added to a collection                                                               |
| `COLLECTION_ITEM_DELETE`                       | An item was removed from a collection                                                           |
| `COLLECTION_ITEM_UPDATE`                       | An item in a collection was updated (e.g. was moved to another collection)                      |
