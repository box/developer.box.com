...
| ------------------------- | ------------------- | ----- | ------------ | --------- |
| [Platformアプリ][custom-app] | あり                  | あり    | あり           | いいえ       |
| [アクセス制限付きアプリ][la-app]     | いいえ                 | いいえ   | いいえ          | あり        |
...
| --------------- | --------- | --- | ---------- | ------- |
| ユーザーの関与が必要?     | あり        | いいえ | いいえ        | いいえ     |
| 管理者の承認が必要?      | いいえ       | あり  | あり         | あり      |
| 他のユーザーの代理で操作可能? | あり        | あり  | あり         | いいえ     |
| ユーザーにBoxを表示?    | あり        | いいえ | いいえ        | いいえ     |
| App Userを作成可能?  | いいえ       | あり  | あり         | いいえ     |
