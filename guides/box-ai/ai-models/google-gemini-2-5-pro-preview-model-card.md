...
|-----------|----------|----------|
|Model name|**Google Gemini 2.5 Pro Preview**| The name of the model. |
|API model name|`google__gemini_2_5_pro_preview`| The name of the model that is used in the [Box AI API for model overrides][overrides]. The user must provide this exact name for the API to work. |
...
|Empirical throughput| **323** | The number of tokens the model can generate per second.|
