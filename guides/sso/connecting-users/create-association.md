...
is_index: false
id: sso/connecting-users/create-association
type: guide
total_steps: 2
sibling_id: sso/connecting-users
parent_id: sso/connecting-users
next_page_id: ''
previous_page_id: sso/connecting-users/search-associations
source_url: >-
  https://github.com/box/developer.box.com/blob/master/content/guides/sso/connecting-users/create-association.md
---
