...
There are three main types of applications that can be created in the developer console. They include Custom App, Limited Access App, and Box Custom Skills. You can also create third party and web app integrations.
